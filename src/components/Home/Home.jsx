...
const Home = () => {
  ...
  const linkItems = [
    ...
    },
    {
      ...
      display: role === "admin" || (getAdminCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.users"),
      path: "/dr-omar/users",
      icon: <HiUsers />,
      display: role === "admin" || (getUserCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.settingsApp"),
      path: "/dr-omar/settings",
      display: role === "admin" || (getSettingsCookies === "1" && true) || true,
    },
    // {
    ...
    // },
    {
      ...
      display:
        role === "admin" || (getSpecialContentCookies === "1" && true) || true,
    },
    {
    ...
    },
    {
      ...
      display:
        role === "admin" || (getTermsConditionsCookies === "1" && true) || true,
    },
    // {
    ...
    },
    {
      ...
      display:
        role === "admin" || (getBooksCategoriesCookies === "1" && true) || true,
    },
    {
    ...
    },
    {
      ...
      display:
        role === "admin" || (getImageCategoriesCookies === "1" && true) || true,
    },
    {
    ...
    },
    {
      ...
      display: role === "admin" || (getElderCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.books"),
      path: "/dr-omar/books",
      icon: <GiBookshelf />,
      display: role === "admin" || (getBookCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.audios"),
      path: "/dr-omar/audios",
      icon: <GiSoundWaves />,
      display: role === "admin" || (getAudioCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.images"),
      path: "/dr-omar/images",
      icon: <SlPicture />,
      display: role === "admin" || (getImageCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.articles"),
      path: "/dr-omar/articles",
      icon: <MdArticle />,
      display: role === "admin" || (getArticlesCookies === "1" && true) || true,
    },
    {
      ...
      icon: <FaBell />,
      display:
        role === "admin" || (getNotificationCookies === "1" && true) || true,
    },
    {
      title: t("linkItems.messages"),
      path: "/dr-omar/messages",
      icon: <MdOutlineMarkunread />,
      display: role === "admin" || (getMessageCookies === "1" && true) || true,
    },
    // {
